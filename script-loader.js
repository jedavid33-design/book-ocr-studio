...
(async () => {
  const response = await fetch("./script.js?v=2.7.41-repair-state-and-raw-persistence", { cache: "no-store" });
  if (!response.ok) {
  ...
  source += "\n//# sourceURL=book-ocr-studio-2.7.41-repair-state-and-raw-persistence.js";
