...
(async () => {
  const response = await fetch("./script.js?v=2.7.66-cloudlibrary-dropcap-ownership", { cache: "no-store" });
  if (!response.ok) {
  ...
  source += "\n//# sourceURL=book-ocr-studio-2.7.66-cloudlibrary-dropcap-ownership.js";
