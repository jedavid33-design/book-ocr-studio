...
(async () => {
  const response = await fetch("./script.js?v=2.7.53-final-polish-quote-left-shift", { cache: "no-store" });
  if (!response.ok) {
  ...
  source += "\n//# sourceURL=book-ocr-studio-2.7.53-final-polish-quote-left-shift.js";
