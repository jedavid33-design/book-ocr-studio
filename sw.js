const CACHE_NAME = "book-ocr-studio-shell-v2-7-32-polish-review-restore";
const APP_SHELL = [
  "./styles.css?v=2.7.32-polish-review-restore",
  "./epub-polish.js?v=2.7.32-polish-review-restore",
