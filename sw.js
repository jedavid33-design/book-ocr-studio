const CACHE_NAME = "book-ocr-studio-shell-v2-8-0-cloudlibrary-iowan-italics";
const APP_SHELL = [
  "./styles.css?v=2.8.0-cloudlibrary-iowan-italics",
  "./epub-polish.js?v=2.8.0-cloudlibrary-iowan-italics",
