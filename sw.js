const CACHE_NAME = "book-ocr-studio-shell-v2-7-29-redetect-existing-chapters";
const APP_SHELL = [
  "./styles.css?v=2.7.29-redetect-existing-chapters",
  "./epub-polish.js?v=2.7.29-redetect-existing-chapters",
