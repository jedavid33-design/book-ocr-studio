const CACHE_NAME = "book-ocr-studio-shell-v2-7-69-cloudlibrary-iowan-ocr-cleanup";
const APP_SHELL = [
  "./styles.css?v=2.7.69-cloudlibrary-iowan-ocr-cleanup",
  "./epub-polish.js?v=2.7.69-cloudlibrary-iowan-ocr-cleanup",
