const CACHE_NAME = "book-ocr-studio-shell-v2-7-31-decade-epilogue-detection";
const APP_SHELL = [
  "./styles.css?v=2.7.31-decade-epilogue-detection",
  "./epub-polish.js?v=2.7.31-decade-epilogue-detection",
