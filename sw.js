const CACHE_NAME = "book-ocr-studio-shell-v2-7-48-manual-edits-win-last";
const APP_SHELL = [
  "./styles.css?v=2.7.48-manual-edits-win-last",
  "./epub-polish.js?v=2.7.48-manual-edits-win-last",
